...
public class baekjoon10810 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int basketCount = Integer.parseInt(br.readLine());
        int[] basket = new int[basketCount];

        int lineCount = Integer.parseInt(br.readLine()); // 몇번에 걸쳐 넣을지 라인

        for (int i = 0; i < lineCount; i++) {
            int startBasket = Integer.parseInt(br.readLine()); // i
            int endBasket = Integer.parseInt(br.readLine()); // j
            int inputBall = Integer.parseInt(br.readLine()); // k
